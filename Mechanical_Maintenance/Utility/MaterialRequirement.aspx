                  ...
                  <div class="container">
					...
					<div class="row">
                        ...
                        <div class="row">
								...
								<div class="col" align="center"><FONT size="5">&nbsp;Material Requirement for Annual Shut-down&nbsp; 
										&nbsp;</FONT>&nbsp;
									<asp:label id="lblConsignee" runat="server"></asp:label></div>
							</div><br />
							<div class="row">
							...
							<div class="row">
								...
								<div class="col">Qty Req</div>
								
								<div class="col"><asp:textbox id="txtQty" runat="server" AutoPostBack="True" CssClass="form-control"></asp:textbox><asp:label id="lblUnitName" runat="server"></asp:label></div>
							...
							<div class="row">
								<div class="col">RecoupType</div>
								
								<div class="col"><asp:label id="lblRecoupType" runat="server"></asp:label>&nbsp;</div>
								<div class="col">RecoupQty</div>
								
								<div class="col"><asp:label id="lblRecoupQty" runat="server"></asp:label>&nbsp;</div>
							
								<div class="col">Year</div>
								
								<div class="col"><asp:textbox id="txtYear" runat="server" CssClass="form-control"></asp:textbox></div>
								</div><br />
							<div class="row">
								...
								<div class="col">Stock in Store :</div>
									<div class="col"><asp:Label id="lblStockInStore" runat="server"></asp:Label></div>
