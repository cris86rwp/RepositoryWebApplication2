...
Public Class EditDrawFurnaceZoneTemp
    ...
    Protected WithEvents Zone7t As System.Web.UI.WebControls.TextBox
    Protected WithEvents Zone8t As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'If rdo1.SelectedValue = "add" Then
        '    strmode = "add"
        'ElseIf rdo1.SelectedValue = "edit" Then
        '    strmode = "edit"
        'ElseIf rdo1.SelectedValue = "view" Then
        '    strmode = "view"
        'ElseIf rdo1.SelectedValue = "delete" Then
    ...
    Private Sub grdDrawFurnace_EditCommand(ByVal source As Object, ByVal objArgs As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles grdDrawFurnace.EditCommand
        If strmode = "edit" Then
            ...
            strSql = "select convert(varchar(50),temperature_reading_time,108) as mytime, zone1t,zone2t,zone3t,zone4t,zone5t,zone6t,zone7t,zone8t ,remarks from mm_draw_furnace_temperatures1 where df_date='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "'"
            BindDataGrid(strSql)
        End If
    End Sub
    ...
    Private Sub grdDrawFurnace_UpdateCommand(ByVal source As Object, ByVal objArgs As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles grdDrawFurnace.UpdateCommand
        ...
        Try
            ...
            strUpdSql = "Update mm_draw_furnace_temperatures1 set  remarks='" & Trim(remarks.Text) & "' where df_date='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "' and temperature_reading_time='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & " " & time & "'"
    ...
    Private Sub grdDrawFurnace_DeleteCommand(ByVal source As Object, ByVal objArgs As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles grdDrawFurnace.DeleteCommand
        If strmode = "delete" Then
            ...
            strsql = "delete from mm_draw_furnace_temperatures1 where df_date='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "' and temperature_reading_time='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & " " & time & "'"
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If btnSave.Text = "Save" Then
            ...
            sqlPara(8) = New SqlParameter("@Zone2t", CSng(Trim(Zone2t.Text)))
            sqlPara(9) = New SqlParameter("@Zone3t", CSng(Trim(Zone3t.Text)))
            sqlPara(10) = New SqlParameter("@Zone4t", CSng(Trim(Zone4t.Text)))
            sqlPara(11) = New SqlParameter("@Zone5t", CSng(Trim(Zone5t.Text)))
            sqlPara(12) = New SqlParameter("@Zone6t", CSng(Trim(Zone6t.Text)))
            sqlPara(13) = New SqlParameter("@Zone7t", CSng(Trim(Zone7t.Text)))
            sqlPara(7) = New SqlParameter("@Zone8t", CSng(Trim(Zone8t.Text)))
            sqlPara(14) = New SqlParameter("@SIC", Trim(TextBox1.Text))


            Dim sqlstr As String = "insert into mm_draw_furnace_temperatures1(df_date,shift_code,shift_operator,hsd_reading_at_815,temperature_reading_time,zone1t,zone2t,zone3t,zone4t,zone5t,zone6t,zone7t,zone8t,remarks,SIC) values("
            sqlstr &= "@txtDate,@cboShift,@txtOperator_name,@txtHSD_meter_reading,@cboTime,@Zone1t,@Zone2t,@Zone3t,@Zone4t,@Zone5t,@Zone6t,@Zone7t,@Zone8t,@txtRemarks,@SIC)"
            'Dim Done As Boolean
            'Dim cmd1 As String
            ...
            sqlstr2 = "select convert(varchar(50),temperature_reading_time,108) as mytime, zone1t,zone2t,zone3t,zone4t,zone5t,zone6t,zone7t,zone8t,remarks from mm_draw_furnace_temperatures1 where df_date='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "'"
            grdDrawFurnace.EditItemIndex = -1
        ...
        ElseIf btnSave.Text = "Update" Then
            ...
            sqlPara(14) = New SqlParameter("@SIC", Trim(TextBox1.Text))
            Try
                strSql = "update mm_draw_furnace_temperatures1 set df_date=@txtDate,shift_code=@cboshift,SIC=@SIC,shift_operator=@txtOperator_name,hsd_reading_at_815=@txtHSD_meter_reading,temperature_reading_time=@cboTime,zone1t=@zone1t,zone2t=@zone2t,zone3t=@zone3t, zone4t=@zone4t,zone5t=@zone5t,zone6t=@zone6t,zone7t=@zone7t, zone8t=@zone8t,remarks=@txtRemarks where df_date='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "' and shift_code = '" & cboShift.SelectedItem.Text & "'"
        ...
        sqlstr4 = "select convert(varchar(50),temperature_reading_time,108) as mytime,zone1t,zone2t,zone3t,zone4t,zone5t,zone6t,zone7t,zone8t ,remarks from mm_draw_furnace_temperatures1 where df_date='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "' and shift_code = '" & cboShift.SelectedItem.Text & "'"
        grdDrawFurnace.EditItemIndex = -1
        ...
        '            Try
        '                strsql = "update mm_draw_furnace_temperatures1 set shift_operator=@txtOperator_name,hsd_reading_at_815=@txtHSD_meter_reading where df_date='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "'"
        ...
        '            strsql = "delete from mm_draw_furnace_temperatures1 where df_date='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "'"
    ...
    Sub fillDFData()
        ...
        End If
        Try
            sqlstr = "select shift_operator,hsd_reading_at_815 from  mm_draw_furnace_temperatures1 where df_date='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "'"
    ...
    Private Sub txtDate_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDate.TextChanged
        Try
            ...
            If strmode = "edit" Or strmode = "delete" Or strmode = "view" Then
                ...
                sqlstr3 = "select convert(varchar(50),temperature_reading_time,108) as mytime, zone1t,zone2t,zone3t,zone4t,zone5t,zone6t,zone7t,zone8t,remarks from mm_draw_furnace_temperatures1 where df_date='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "' and shift_code = '" & cboShift.SelectedItem.Text & "'"
