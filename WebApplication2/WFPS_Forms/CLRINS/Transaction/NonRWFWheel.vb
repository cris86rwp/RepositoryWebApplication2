Public Class NonRWFWheel1
    ...
    Public Shared Function RWFNumDetails(ByVal RWFNumber As Integer) As DataTable
        ...
        oDa.SelectCommand.CommandText = "Select Description, NonRWFWheelNumber, thread_diameter, " &
         " rwfNumber, isnull(press_status,'') Press_status from mm_nonrwf_wheels " &
    ...
    Public Shared Function PopulateGrid(ByVal DateAccepted As Date) As DataTable
        ...
        oDa.SelectCommand.CommandText = "Select NonRWFWheelNumber wheel, RWFNumber , thread_diameter, sl_no " &
