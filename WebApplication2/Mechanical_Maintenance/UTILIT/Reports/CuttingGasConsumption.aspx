       ...
       <li class="nav-item">
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel3" runat="server">
                ...
                <div class="table">
					<div class="row">
						<div class="col" align="center"><h3><strong> Cutting Gas Consumption Between Dates</strong></h3></div>
					</div>
					<div class="row">
						<div class="col">
                   ...
                   <%-- <TR>
                    ...
                    <div class="row">
						...
						<div class="col">
							<asp:textbox id="Textbox1" runat="server" Width="103px" CssClass="form-control"></asp:textbox></div>
					<div class="col"></div>
						<div class="col">To Date</div>
						<div class="col">
							<asp:textbox id="Textbox2" runat="server" Width="103px" CssClass="form-control"></asp:textbox></div>
                    ...
                    <div class="row">
						<div class="col" align="center">
                          <asp:button id="Button1" runat="server" Text="Submit"  Font-Size="16px"  BorderStyle="Solid" Font-Bold="True"  CssClass="btn btn-dark" ></asp:button>
    ...
    return date;
            ...
            $(document).ready(function () {
                        ...
                        $('#Textbox2').datepicker({
                            ...
                            onSelect: function(date){            
                                var date1 = $('#Textbox2').datepicker('getDate');           
