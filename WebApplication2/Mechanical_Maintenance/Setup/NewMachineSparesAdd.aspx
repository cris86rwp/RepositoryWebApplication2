                 ...
                 <div class="table-responsive">
			        <asp:panel id="Panel1" runat="server">
                            ...
                            <div class="container-fluid">
								<div class="row">
									<div class="col">
                                         <b><h1 align="middle" colspan="6">Machine Spares - Add<hr class="prettyline" />
                                        </h1></b> 
                                     </div>
                                    </div>
							 ...
							 <div class="container-fluid">
								...
								<div class="row">
									...
									<div class="col-2"><asp:DropDownList id="ddlMachines" runat="server" CssClass="form-control ll" AutoPostBack="True"></asp:DropDownList></div>
									<div class="col-2"></div>
                                    <div class="col-2">PLNumber</div>
									<div class="col-2"><asp:TextBox id="txtPLNumber" runat="server" AutoPostBack="True" CssClass="form-control"></asp:TextBox></div>
                               ...
                               <br />
								<div class="row">
                                 ...
                                 <br />
                                 	<div class="row">
									<div class="col-2">
                                 <asp:TextBox id="txtDesc" runat="server" CssClass="form-control" ReadOnly="True" TextMode="MultiLine" Visible="false"></asp:TextBox>
                                        </div>
                                         </div>
                                 <br />
                                 </div>
