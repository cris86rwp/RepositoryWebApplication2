           ...
           <%-- <div class="row">
			...
			<asp:Panel id="Panel1" runat="server" >
               <div class="row">
						...
						<div class="col" align="center" colSpan="6"><hr class="prettyline" /></div >
                        </div ><br />
					<div class="row">
						<div class="col" align="center"><FONT size="5">Material Requirement for Annual Shut-down&nbsp;- Edit&nbsp;-
								<asp:label id="lblConsignee" runat="server"></asp:label></FONT></div >
					</div ><br />
				...
				<br />
					<div class="row">
						...
						<div class="col">
							<asp:dropdownlist id="ddlPlNumber" runat="server" AutoPostBack="True" CssClass="form-control ll"></asp:dropdownlist></div >
						<div class="col">Qty Req</div >
						
						<div class="col">
							<asp:textbox id="txtQty" runat="server" AutoPostBack="True" CssClass="form-control"></asp:textbox>
							<asp:label id="lblUnitName" runat="server"></asp:label></div >
                ...
                <br />
					<div class="row">
						...
						<div class="col">
							<asp:label id="lblRecoupType" runat="server"></asp:label>&nbsp;</div >
						<div class="col">RecoupQty</div >
		
						<div class="col">
							<asp:label id="lblRecoupQty" runat="server"></asp:label>&nbsp;</div >
					
						<div class="col">Year</div >
						
						<div class="col">
							<asp:textbox id="txtYear" runat="server" CssClass="form-control"></asp:textbox></div >
                        </div >
                <br />
					<div class="row">
						...
						<div class="col">
							<asp:textbox id="txtEquip" runat="server" CssClass="form-control"></asp:textbox></div >
					
						<div class="col" >Stock in Store 
							<asp:Label id="lblStockInStore" runat="server"></asp:Label></div>
							<div class="col"><asp:label id="lblUnitName1" runat="server"></asp:label></div >
                ...
                <br />
                <div class="row">
						<div class="col" vAlign="top" align="left" colSpan="9">Saved&nbsp; Data for report :</div >
					</div >
