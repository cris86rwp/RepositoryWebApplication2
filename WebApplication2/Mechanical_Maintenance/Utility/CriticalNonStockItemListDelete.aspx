       ...
       <li class="nav-item">
        ...
        <img src="../../../NewFolder1/CRIS-Recruitment.jpg" height="45" style="border-radius:43%"/>
                ...
                <div class="container">
							...
							<div class="row">
								<div class="col" align="center"><FONT size="5">
                    ...
                    <br />
							<div class="row">
								...
								<div class="col">
									<asp:DropDownList id="ddlPLNumber" runat="server" AutoPostBack="True" CssClass="form-control ll" Width="103px"></asp:DropDownList></div>
								<div class="col">Sl No</div>
								
								<div class="col"><asp:textbox id="txtSlNo" runat="server" AutoPostBack="True" CssClass="form-control" Width="103px"></asp:textbox></div>
                    ...
                    <br />
							<div class="row">
								...
								<div class="col"><asp:textbox id="txtSup" runat="server" CssClass="form-control" Width="103px">
                    ...
                    <br />
							<div class="row">
								...
								<div class="col"><asp:textbox id="txtRemarks" CssClass="form-control" runat="server" Width="103px"></asp:textbox></div>
                                <div class="col"></div>
                                <div class="col"></div>
                    ...
                    <br />
							<div class="row">
								<div class="col" align="center">
									...
									<asp:Label id="lblRecID" runat="server" Visible="False"></asp:Label></div>
							</div>
					<br />
