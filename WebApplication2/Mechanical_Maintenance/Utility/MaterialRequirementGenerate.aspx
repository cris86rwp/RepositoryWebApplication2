		...
		<form id="Form1" method="post" runat="server">
           ...
           --%>
			...
			<asp:Panel id="Panel1" runat="server" >
             <div class="table">
				<div class="row">
					<div class="col" align="center">Material Requirement Report Generate-
				...
				<div class="row">
					<div class="col">
						<asp:RadioButtonList id="rblYear" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="rbl"></asp:RadioButtonList></div>
				</div>
                <br />
				<div class="row">
					<div class="col" align="center">
                     <asp:button id="btnShow" runat="server" Text="Generate Report"  Font-Size="16px"  BorderStyle="Solid" Font-Bold="True"  CssClass="btn btn-dark" ></asp:button>
					</div>	
				</div>
