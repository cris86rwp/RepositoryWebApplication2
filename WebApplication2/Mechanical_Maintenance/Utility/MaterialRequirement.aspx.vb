...
#End Region
    ...
    Private Sub txtPlNumber_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPlNumber.TextChanged
        ...
        Try
            ds = CriticalItems.ItemTables.PLDetails(txtPlNumber.Text, lblConsignee.Text)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            SaveList.RecID = CheckPl(txtPlNumber.Text.Trim, lblConsignee.Text.Trim)
    ...
    Private Sub PopulateSavedData(ByVal PLNumber As String, ByVal Consignee As String)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                lblMessage.Text = "Use Edit mode to change data !"
            End If
