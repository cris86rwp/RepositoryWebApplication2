Public Class PTMSCriticalItemListUndoDelete
...
#End Region
    ...
    Private Sub PopulateDDL(ByVal Consignee As String)
        ...
        Try
            dvPLNumber.Table = CriticalItems.ItemTables.GetProdConsumablesPls(lblConsignee.Text, False, True, True)
    ...
    Private Sub PopulateSavedData(ByVal PLNumber As String, ByVal Consignee As String)
        ...
        Dim ds As New DataSet()
        Try
            ds = CriticalItems.ItemTables.ProdCriticalSelectionList(PLNumber, lblConsignee.Text.Trim, ddlPlNumber.SelectedItem.Value, True)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            Try
                ...
                If SaveProdList.SaveProdCriticalList(SaveProdList.RecID, False, True) Then
                    blnSave = True
                    ClearVal()
                End If
                PopulateDDL(lblConsignee.Text)
