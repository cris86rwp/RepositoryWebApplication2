...
tmp.mnemonic = ' ';
mP01.add(tmp = new MenuItem("Employee CRs","/ppms/Reports/Formats/CRFormats/CRFORMATS.ASPX"));tmp.mnemonic = '';mQ00.add(tmp = new MenuItem("Priority Register",null,null, mQ01) );
tmp.mnemonic = '';
mQ00.add(tmp = new MenuItem("Quarter Allotment",null,null, mQ02) );
tmp.mnemonic = '';
mRH01.add(tmp = new MenuItem("Post Allotment",null,null, mRH02) );
tmp.mnemonic = '';
mRH01.add(tmp = new MenuItem("Print Allotment","/ppms/quest/hr_RestHouseAllotmentPrint.aspx"));tmp.mnemonic = '';mRH01.add(tmp = new MenuItem("View Availability","/ppms/quest/QRestHouse.aspx"));tmp.mnemonic = '';
mRH02.add(tmp = new MenuItem("Add","/ppms/quest/RestHouseAllotment.aspx?mode=add"));tmp.mnemonic = '';
mRH02.add(tmp = new MenuItem("Edit","/ppms/quest/RestHouseAllotment.aspx?mode=edit"));tmp.mnemonic = '';
mRH02.add(tmp = new MenuItem("Delete","/ppms/quest/RestHouseAllotment.aspx?mode=delete"));tmp.mnemonic = '';
