...
tmp.mnemonic = '';
mP01.add(tmp = new MenuItem("Blood Group Updation","/ppms/employee/HrBloodGroup.aspx"));tmp.mnemonic = '';mP01.add(tmp = new MenuItem("Cash Remittance Form","http://172.16.25.59/ppms/reports/formats/Applicationforms/employee_remittance_form.rpt?user0=wap&password0=wap&user0@employee_remittance_code=wap&password0@employee_remittance_code=wap"));tmp.mnemonic = '';mP01.add(tmp = new MenuItem("Children Education Form","http://172.16.25.59/ppms/reports/formats/Applicationforms/childreneducation_form.rpt?user0=wap&password0=wap"));tmp.mnemonic = '';mP01.add(tmp = new MenuItem("Leave Encashment Form","http://172.16.25.59/ppms/reports/formats/Applicationforms/Encashmentform.pdf"));tmp.mnemonic = '';mP01.add(tmp = new MenuItem("Employee ID Card Format","http://172.16.25.59/ppms/reports/formats/Applicationforms/hr_Employee_IDCard_Format.rpt?user0=wap&password0=wap"));tmp.mnemonic = '';mP01.add(tmp = new MenuItem("LOKPAL and LOKAYUKTAS ACT","http://172.16.25.59/ppms/reports/formats/Applicationforms/LOKPAL_ACT.pdf"));tmp.mnemonic = '';mP01.add(tmp = new MenuItem("Officers Immovable Property Returns(IPR)","http://172.16.25.59/ppms/reports/formats/Applicationforms/Gaz_IPR_Format.pdf"));tmp.mnemonic = '';mP01.add(tmp = new MenuItem("Employees Immovable Property Returns(IPR)","http://172.16.25.59/ppms/reports/formats/Applicationforms/NonGaz_IPR_Format.pdf"));tmp.mnemonic = '';mQ00.add(tmp = new MenuItem("Application",null,null, mQ001) );
tmp.mnemonic = ' ';
