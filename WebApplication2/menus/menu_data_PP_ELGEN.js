...
tmp.mnemonic = '';
mQYM.add(tmp = new MenuItem("HR-General Queries","/ppms/hrquery.aspx"));tmp.mnemonic = '';mT01.add(tmp = new MenuItem("TA City Classes",null,null, mT16) );
tmp.mnemonic = '';
mT01.add(tmp = new MenuItem("TA Advance",null,null, mT12) );
tmp.mnemonic = '';
mT01.add(tmp = new MenuItem("Create Noting","/ppms/ta/createNotingForTA.aspx"));tmp.mnemonic = '';mT01.add(tmp = new MenuItem("Print Noting","/ppms/ta/taPrintNoting.aspx"));tmp.mnemonic = '';mT01.add(tmp = new MenuItem("Generate Memorandum","/ppms/ta/taMemorandum.aspx"));tmp.mnemonic = '';mT01.add(tmp = new MenuItem("Print Memorandum","/ppms/ta/taPrintMemorandum.aspx"));tmp.mnemonic = '';mT01.add(tmp = new MenuItem("Posting to Payroll","/ppms/ta/taPosting.aspx?post=P"));tmp.mnemonic = '';mT01.add(tmp = new MenuItem("Posting to Supplementary","/ppms/ta/taPosting.aspx?post=S"));tmp.mnemonic = '';mT80.add(tmp = new MenuItem("TA Journal entry",null,null, mT81) );
tmp.mnemonic = '';
