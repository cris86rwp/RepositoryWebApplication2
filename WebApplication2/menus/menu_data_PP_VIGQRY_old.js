...
Menu.prototype.cssFile = '/ppms/menus/skins/officexp/officexp.css';
var mV00= new Menu();var mZ02= new Menu();var mPPR0= new Menu();var mQYM= new Menu();var mV02= new Menu();var mZ12= new Menu();var mZ61= new Menu();var mZ63= new Menu();var mZ49= new Menu();var mZ20= new Menu();
var tmp;
mPPR0.add(tmp = new MenuItem("View","/ppms/payslip/frmPayslip.aspx"));tmp.mnemonic = ' ';mQYM.add(tmp = new MenuItem("HR-General Queries","/ppms/hrquery.aspx"));tmp.mnemonic = '';mV00.add(tmp = new MenuItem("Remarks",null,null, mV02) );
tmp.mnemonic = '';
