...
tmp.mnemonic = '';
mL02.add(tmp = new MenuItem("Officer Leave Memorandum","/ppms//leave/ofcrmemo.rpt?user0=wap&password0=wap"));tmp.mnemonic = '';mL02.add(tmp = new MenuItem("Encashment Memorandum","/ppms//leave/encashment_memorandum.rpt?user0=wap&password0=wap"));tmp.mnemonic = '';mP01.add(tmp = new MenuItem("View Brief Details",null,null, mP101) );
tmp.mnemonic = ' ';
