<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="JMPSampleDataNew.aspx.vb" Inherits="WebApplication2.JMPSampledataNew" %>
        ...
        <div class="row"><div class="table-responsive">
           ...
           <asp:Label ID="lblhsts1" Text="Heat Status" runat="server"  Visible="false"></asp:Label> 
                  ...
                  <td colspan="2"><asp:TextBox ID="txtremarks" runat="server" CssClass="form-control" TabIndex="20"></asp:TextBox></td>
                      ...
                      <tr>
                    <td colspan="2"><asp:Button ID="btnsave" runat="server" Text="SAVE" CssClass="button button2" />
                        <asp:Button ID="btnupd" runat="server" Text="UPDATE" CssClass="button button2" />
                    </td>
                    <td colspan="2"><asp:Button ID="btnclear" runat="server" Text="CLEAR" CssClass="button button2"/></td>
                           <td colspan="2"><asp:Button ID="btnedit" runat="server" Text="EDIT" CssClass="button button2"/></td>
