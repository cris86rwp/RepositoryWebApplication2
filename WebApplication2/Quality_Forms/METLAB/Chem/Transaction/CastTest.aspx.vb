Public Class CastTest
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            Select Case lblMode.Text
                Case "edit"
                    cboLab_number.Visible = False
                    txtAxleNumber.Visible = True
            End Select
        End If
    End Sub

    Private Sub getLab_numbers()
        ...
        Try
            ...
            cboLab_number.Items.Insert(0, "Select")
    ...
    Private Sub ForEditModeOnAxleNumberChange()
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                If Not IsDBNull(ds.Tables(0).Rows(0)("sent_date")) Then lblSend_Date.Text = ds.Tables(0).Rows(0)("sent_date")
                If Not IsDBNull(ds.Tables(0).Rows(0)("cast_group")) Then lblGropu.Text = ds.Tables(0).Rows(0)("cast_group")
                If Not IsDBNull(ds.Tables(0).Rows(0)("cast_number")) Then lblCast_number.Text = ds.Tables(0).Rows(0)("cast_number")
                If Not IsDBNull(ds.Tables(0).Rows(0)("drawing_number")) Then lblProdno.Text = ds.Tables(0).Rows(0)("drawing_number")
                If Not IsDBNull(ds.Tables(0).Rows(0)("result")) Then
                    If CStr(ds.Tables(0).Rows(0)("result")).ToUpper = "P" Then
                        radResult.SelectedIndex = 0
                    ElseIf CStr(ds.Tables(0).Rows(0)("result")).ToUpper = "R" Then
                        radResult.SelectedIndex = 1
                    End If
                End If
            End If
            If ds.Tables(1).Rows.Count > 0 Then
                If Not IsDBNull(ds.Tables(1).Rows(0)("cast_number")) Then lblCast_number.Text = ds.Tables(1).Rows(0)("cast_number")
                If Not IsDBNull(ds.Tables(1).Rows(0)("billet_number")) Then billet_number = ds.Tables(1).Rows(0)("billet_number")
            End If
        Catch exp As Exception
            lblMessage.Text = exp.Message
        End Try
    ...
    Private Sub cboLab_number_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboLab_number.SelectedIndexChanged
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                If Not IsDBNull(dt.Rows(0)("sent_date")) Then lblSend_Date.Text = dt.Rows(0)("sent_date")
                If Not IsDBNull(dt.Rows(0)("cast_group")) Then lblGropu.Text = dt.Rows(0)("cast_group")
                If Not IsDBNull(dt.Rows(0)("cast_number")) Then lblCast_number.Text = dt.Rows(0)("cast_number")
                If Not IsDBNull(dt.Rows(0)("drawing_number")) Then lblProdno.Text = dt.Rows(0)("drawing_number")
            End If
            lblMessage.Text = ""
            If lblCast_number.Text <> "" Then
                dt = metLab.tables.getCastDetails(lblCast_number.Text.Trim)
                If dt.Rows.Count > 0 Then lblMessage.Text = dt.Rows(0)(0)
                If lblMessage.Text <> "" Then lblMessage.Text = "Details of Last test : " & lblMessage.Text
            End If
        Catch exp As Exception
            lblMessage.Text = exp.Message
        Finally
    ...
    Private Sub SaveValues()
        ...
        If d.Compare(d, Date.Today) > 0 Then
            ...
            Exit Sub
        End If
        If cboLab_number.SelectedIndex = 0 Then
            lblMessage.Text = "Select A Lab Number"
            Exit Sub
        End If
        Dim Done As Boolean
        Try
            Done = New metLab.AxleCastTest().CasttestPhysicalValues(cboLab_number.SelectedItem.Text.Trim, CDate(txtDate.Text), lblLabNumber.Text.Trim, Val(txtUT_strength.Text), Val(txtYield_strength.Text), Val(txtElongation.Text), Val(txtReduction.Text), Val(txtCharpy.Text), txtASTM.Text, txtVert_macro.Text, txtLong_macro.Text, txtRemarks.Text, radResult.SelectedItem.Value)
            If Done Then
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If lblMode.Text.Equals("add") Then
            If Trim(btnSave.Text.ToUpper) = "SAVE" Then
                SaveValues()
