     ...
     <div class="container">
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel1"  runat="server">
				<div class ="table">
					 <div class="row">
						<div class="col" align="center"><STRONG><FONT size="5px">Test Result Certificate </FONT></STRONG></div>
					</div>
                    <br />
					<div class="row">
						<div class="col" >
