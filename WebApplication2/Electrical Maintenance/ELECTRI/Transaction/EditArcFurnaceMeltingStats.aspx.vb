Public Class EditArcFurnaceMeltingStats
...
#End Region
    ...
    Public Function checks()
        Dim Melt_no As String = txtMelt_no.Text
        Dim consumption_date As String = txtDate.Text
        Dim sqlCmd As SqlClient.SqlCommand = rwfGen.Connection.CmdObj
        sqlCmd.Connection.Open()
        sqlCmd.CommandText = " SELECT COUNT(*) FROM ms_furnace_melting_statistics1 where  Melt_no = @Melt_no and Consumption_date = @consumption_date "

        sqlCmd.Parameters.AddWithValue("@Melt_no", Melt_no)
        sqlCmd.Parameters.AddWithValue("@Consumption_date", consumption_date)

        Try
            Dim i As Integer = Convert.ToInt32(sqlCmd.ExecuteScalar())
            Return i
        Catch exp As Exception
    ...
    Private Sub btnSubmit_Clicks_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSubmit_Clicks.Click
        ...
        If Done Then
            ...
            ElseIf lblMode.Text.ToLower = "edit" Then
