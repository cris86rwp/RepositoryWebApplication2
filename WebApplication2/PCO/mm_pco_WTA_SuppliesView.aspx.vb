Public Class mm_pco_WTA_SuppliesView
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Page.IsPostBack = False Then
            ...
            ddlConsigneeCode.Enabled = False
            txtOrderedQty.Enabled = False
            txtSupplyRemarks.Enabled = False
        ...
        End If
    End Sub
    Private Sub populatePlanGrid(Optional ByVal planID As Long = 0, Optional ByVal curPage As Integer = 0)
        ...
        dgPlanDetails.CurrentPageIndex = curPage
        dgPlanDetails.DataBind()
    End Sub
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If ChkQty() = True Then
            Try
                ...
                btnSave = CType(viewstate("WTA_Supplies"), PCO.WTA_PlannedSupplies).Save(True)
                populateDataGrid(lblPlanID.Text)
                populateConsigneeCode()
                txtOrderedQty.Text = ""
                txtSupplyRemarks.Text = ""
    ...
    Private Sub dgData_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgData.ItemCommand
        ...
        Try
            ...
            CType(viewstate("WTA_Supplies"), PCO.WTA_PlannedSupplies).SupplyID = e.Item.Cells(1).Text
            ...
            txtSupplyRemarks.Text = e.Item.Cells(6).Text
            CType(viewstate("WTA_Supplies"), PCO.WTA_PlannedSupplies).SupplyID = e.Item.Cells(1).Text
            If CType(viewstate("WTA_Supplies"), PCO.WTA_PlannedSupplies).CheckSupplyCompliance() Then
                lblMessage.Text = " Warning : Confirm before deleting ConsigeneeCode as there are despatches ! "
            End If
        Catch exp As Exception
            lblMessage.Text = exp.Message
        End Try
    ...
    Private Sub dgPlanDetails_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles dgPlanDetails.PageIndexChanged
        dgPlanDetails.CurrentPageIndex = e.NewPageIndex
        populatePlanGrid(0, e.NewPageIndex)
    End Sub
End Class
