...
Public Class Drinking_Water
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebApplication2.Drinking Water.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_lab_number() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDrinking_Water
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Drinking_Water = New Drinking_Water()
        rpt.Site = Me.Site
        Return rpt
    End Function
