...
#End Region
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        DataGrid1.DataBind()
        Try
            DataGrid1.DataSource = MouldMaster.MRSMRS.MouldPerformance(CDate(txtFromDate.Text), CDate(txtToDate.Text), rblQry.SelectedItem.Value)
            DataGrid1.DataBind()
        Catch exp As Exception
            lblMessage.Text = exp.Message
        End Try
