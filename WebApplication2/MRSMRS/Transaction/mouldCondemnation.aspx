    ...
    function isInputNumber(evt) {
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:Panel id="Panel1"  runat="server"><%--style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute; TOP: 8px"--%>
                ...
                <div class="table">
					<div class="row">
						<div class="col" align="center"><h3><strong>Mould Condemnation(after machining)</strong></h3>
					...
					<div class="row">
						...
						<div class="col"">Mould Number <span class="glyphicon-asterisk"></span></div>
					
						<div class="col">
							<asp:textbox id="txtMouldNumber" runat="server" AutoPostBack="true" CssClass="auto-style1" ToolTip="Enter only numeric value" onkeypress="isInputNumber(event)" Width="90px"></asp:textbox>
							<asp:requiredfieldvalidator id="rfvMldNo" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="txtMouldNumber"></asp:requiredfieldvalidator></div>
						</div><br />
                    <div class="row" >
					...
					<div class="row">
						...
						<div class="col" >
							<asp:label id="lblInitialHt" runat="server"></asp:label>&nbsp;</div>
						<div class="col" >Final Ht</div>
						
						<div class="col">
							<asp:label id="lblFinalHt" runat="server"></asp:label>&nbsp;</div>
					
				
						<div class="col" >Remarks</div>
						
						<div class="col">
							<asp:textbox id="txtremarks" runat="server" CssClass="form-control" MaxLength="200"></asp:textbox></div>
					</div>
                        </div>
                    <br />
					<div class="row">
						<div class="col" align="center">
						     <asp:button id="btnSave" runat="server" Text="Condemn the Mould"  Font-Size="16px"  BorderStyle="Solid" Font-Bold="True"  CssClass="btn btn-dark" ></asp:button></div>
			
					</div>
			
                    <br />
				<asp:DataGrid id="DataGrid1" runat="server"  BackColor="White" CssClass="table" Visible="false"><%--BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4"--%>
