...
<!--/.Navbar -->
     ...
     --%>
			<div class="table" >
				...
				<div class="row"> 
					<div class="col" align="center"><h2>WTA Planned Quantities&nbsp;( Summary )</h2></div>
				</div>
                <br />
				<div class="row"> 
				...
				<div class="row">--%> 
					...
					<%--<div class="col"> :</div>--%>
					<div class="col"> <asp:textbox id="txtQuantityDate" runat="server" AutoPostBack="True" CssClass="form-control" onkeypress="return isNumber1(event,this)" MaxLength="10" placeholder="dd/mm/yyyy"></asp:textbox>
