...
Public Class WheelDespatch
    ...
    Protected Function saveFunc()
        ...
        cmd.CommandText = "Insert INTO mm_despatchMemo(Memo_No, Despatch_Date, Consignee_Name, Wheel_Type, Drawing_No, Specification_No, WtaNo, WtaDate, LorryNo, Driver_name, Driver_ID, Rep_Name, Rep_ContactNo, Quantity, Contractor_Name, Lorry_Placement_time) 
    ...
    Protected Sub gridFunc()
        ...
        Dim str4 As String
        str4 = "select Memo_No,Despatch_Date,Consignee_Name,Wheel_Type,Drawing_No,Specification_No,WtaNo,WtaDate,Rail_Letter,LorryNo,Driver_Name,Driver_ID,Rep_Name,Rep_ContactNo,Quantity,DCNo,Contractor_Name from mm_despatchMemo where Despatch_Date='" & txtdesdate.Text & "'"
